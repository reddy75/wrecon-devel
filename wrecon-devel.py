...
UPDATE             UP[DATE] [BotID]'''
  ...
  def setup_command_variables_verify():
    global BUFFER_CMD_VAL_EXE, BUFFER_CMD_VAL_REP, BUFFER_CMD_VAL_ERR, BUFFER_CMD_VAL_FUNCTION, COMMAND_REQUIREMENTS_REMOTE, COMMAND_REQUIREMENTS_LOCAL, SCRIPT_INTERNAL_CALL, PREPARE_USER_CALL, VERIFY_RESULT_VAL
    ...
    ARGUMENTS_REQUIRED[BUFFER_CMD_VAL_EXE] = 1
