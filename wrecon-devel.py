...
UPDATE             UP[DATE] [BotID]|<INDEX>'''
  ...
  def buffer_command_verify_2_result_received(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    if FINAL_VERIFICATION == True:
      ...
      if UNIQ_COMMAND_ID in VERIFY_SUM_CONTROL:
        del VERIFY_SUM_CONTROL[UNIQ_COMMAND_ID]
      
      if UNIQ_COMMAND_ID in VERIFY_SUM_GRANTED:
        del VERIFY_SUM_GRANTED[UNIQ_COMMAND_ID]
      
      if UNIQ_COMMAND_ID in VERIFY_CONTROL_SECRET_SAVE:
        del VERIFY_CONTROL_SECRET_SAVE[UNIQ_COMMAND_ID]
      
      if UNIQ_COMMAND_ID in VERIFY_GRANTED_SECRET_SAVE:
        del VERIFY_GRANTED_SECRET_SAVE[UNIQ_COMMAND_ID]
  ...
  def function_verify_save_data(BUFFER, TAGS, PREFIX, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS):
    global WRECON_REMOTE_BOTS_VERIFIED, WRECON_REMOTE_BOTS_ADVERTISED, WRECON_REMOTE_BOTS_GRANTED_SECRET
  ...
  def verify_protocol_0_ree(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    global VERIFY_GRANTED_SECRET_SAVE, WRECON_BOT_ID, WRECON_REMOTE_BOTS_GRANTED_SECRET, VERIFY_SUM_GRANTED
    ...
    if ERROR == True:
      ...
      if TARGET_BOT_ID in WRECON_REMOTE_BOTS_GRANTED_SECRET:
        DATA = WRECON_REMOTE_BOTS_GRANTED_SECRET[TARGET_BOT_ID]
      else:
        DATA = []
      VERIFY_GRANTED_SECRET_SAVE[UNIQ_COMMAND_ID] = [TARGET_BOT_ID, DATA]
      VERIFY_SUM_GRANTED[UNIQ_COMMAND_ID]         = get_hash(WRECON_REMOTE_BOTS_GRANTED_SECRET)
  ...
  def verify_protocol_1_eer(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    global VERIFY_CONTROL_SECRET_SAVE, WRECON_BOT_ID, WRECON_REMOTE_BOTS_CONTROL_SECRET, VERIFY_SUM_CONTROL
    ...
    if ERROR == True:
      ...
      if SOURCE_BOT_ID in WRECON_REMOTE_BOTS_CONTROL_SECRET:
        DATA = WRECON_REMOTE_BOTS_CONTROL_SECRET[SOURCE_BOT_ID]
      else:
        DATA = ''
      VERIFY_CONTROL_SECRET_SAVE[UNIQ_COMMAND_ID] = [SOURCE_BOT_ID, DATA]
      VERIFY_SUM_CONTROL[UNIQ_COMMAND_ID]         = get_hash(WRECON_REMOTE_BOTS_CONTROL_SECRET)
  ...
  def verify_protocol_2_rre(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    global WRECON_REMOTE_BOTS_GRANTED_SECRET, PREVIOUS_VERIFY, WRECON_BOT_ID
  ...
  def verify_protocol_3_ner(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    global WRECON_REMOTE_BOTS_CONTROL_SECRET, WRECON_BOT_ID
  ...
  def verify_protocol_4_rvn(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    global VERIFICATION_PROTOCOL, VERIFICATION_REPLY_EXPECT, TEMPORARY_ENCRYPT_KEY1, TEMPORARY_ENCRYPT_KEY2
    global WRECON_REMOTE_BOTS_GRANTED_SECRET, VERIFY_GRANTED_SECRET_SAVE, WRECON_BOT_ID, VERIFY_SUM_GRANTED
    ...
    if not SOURCE_BOT_ID in WRECON_REMOTE_BOTS_GRANTED_SECRET:
      ...
      if ERROR == True:
        ...
        VERIFICATION_REPLY_EXPECT[UNIQ_COMMAND_ID] = VERIFICATION_PROTOCOL[L2_PROTOCOL][1]
        if SOURCE_BOT_ID in WRECON_REMOTE_BOTS_GRANTED_SECRET:
          DATA = WRECON_REMOTE_BOTS_GRANTED_SECRET[SOURCE_BOT_ID]
        else:
          DATA = []
        VERIFY_GRANTED_SECRET_SAVE[UNIQ_COMMAND_ID] = [SOURCE_BOT_ID, DATA]
        VERIFY_SUM_GRANTED[UNIQ_COMMAND_ID]         = get_hash(WRECON_REMOTE_BOTS_GRANTED_SECRET)
  ...
  def verify_protocol_5_vnr(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    global VERIFICATION_PROTOCOL, VERIFICATION_REPLY_EXPECT, TEMPORARY_ENCRYPT_KEY1, TEMPORARY_ENCRYPT_KEY2
    global WRECON_REMOTE_BOTS_CONTROL_SECRET, VERIFY_CONTROL_SECRET_SAVE, WRECON_BOT_ID, VERIFY_SUM_CONTROL
  ...
  def verify_protocol_a_aaa(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    global WRECON_BOT_KEY, WRECON_REMOTE_BOTS_GRANTED_SECRET, VERIFICATION_LAST_L2, WRECON_BOT_ID
  ...
  def setup_command_variables_verify():
    ...
    global VERIFY_CONTROL_SECRET_SAVE, VERIFY_GRANTED_SECRET_SAVE, VERIFY_SUM_CONTROL, VERIFY_SUM_GRANTED
    VERIFY_CONTROL_SECRET_SAVE = {}
    VERIFY_GRANTED_SECRET_SAVE = {}
    VERIFY_SUM_CONTROL         = {}
    VERIFY_SUM_GRANTED         = {}
