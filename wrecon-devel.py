...
UPDATE             UP[DATE] [BotID]|<INDEX>'''
  ...
  def buffer_command_verify(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    # Continue with enhanced level of verification
      ...
      if REMOTE_SECRET_SYSINFO == '':
        ...
        ENCRYPT_LEVEL, ENCRYPT_KEY1, ENCRYPT_KEY2  = VERIFICATION_PROTOCOL[L2_PROTOCOL][2](WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST)
      # Here we have DATA of REMOTE bot, we try verify by 
      else:
        VERIFICATION_REPLY_EXPECT[UNIQ_COMMAND_ID] = ''
  ...
  def buffer_command_verify_1_requested(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    if ENCRYPT_LEVEL > 0:
      if SECRET_DATA in VERIFICATION_PROTOCOL:
        ...
        EXPECTED_FUNC  = VERIFICATION_PROTOCOL[L2_PROTOCOL][1]
        L2_FUNCTION    = VERIFICATION_PROTOCOL[L2_PROTOCOL][2]
        
        ENCRYPT_KEY2, L2_VERIFY_NEW_DATA = L2_FUNCTION(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST)
      else:
  ...
  def verify_protocol_0_ree(WEECHAT_DATA, BUFFER, SOURCE, DATE, TAGS, DISPLAYED, HIGHLIGHT, PREFIX, COMMAND, TARGET_BOT_ID, SOURCE_BOT_ID, COMMAND_ID, COMMAND_ARGUMENTS_LIST):
    ...
    return [ENCRYPT_LEVEL, ENCRYPT_KEY1, ENCRYPT_KEY2]
  
  # 1 - eer (rre) - REMOTE -> LOCAL
